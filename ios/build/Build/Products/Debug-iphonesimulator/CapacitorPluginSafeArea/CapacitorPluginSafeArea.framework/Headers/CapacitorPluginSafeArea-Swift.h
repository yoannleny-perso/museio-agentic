...
#ifndef CAPACITORPLUGINSAFEAREA_SWIFT_H
#define CAPACITORPLUGINSAFEAREA_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="CapacitorPluginSafeArea",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class UIWindow;
SWIFT_CLASS("_TtC23CapacitorPluginSafeArea8SafeArea")
@interface SafeArea : NSObject
- (UIWindow * _Nullable)getWindow SWIFT_WARN_UNUSED_RESULT;
- (UIEdgeInsets)getSafeAreaInsets SWIFT_WARN_UNUSED_RESULT;
- (CGFloat)getStatusBarHeight SWIFT_WARN_UNUSED_RESULT;
...
SWIFT_CLASS_NAMED("SafeAreaPlugin")
@interface SafeAreaPlugin : CAPPlugin <CAPBridgedPlugin>
