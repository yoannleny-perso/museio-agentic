...
#ifndef CAPACITORCOMMUNITYFCM_SWIFT_H
#define CAPACITORCOMMUNITYFCM_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="CapacitorCommunityFcm",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS_NAMED("FCMPlugin")
@interface FCMPlugin : CAPPlugin <FIRMessagingDelegate>
- (void)load;
