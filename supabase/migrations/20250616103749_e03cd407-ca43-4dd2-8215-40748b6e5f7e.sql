...
-- Delete all data for user ivan.guelton@gmail.com
DO $$
DECLARE
    target_user_id UUID;
BEGIN
    ...
    FROM auth.users 
    WHERE email = 'ivan.guelton@gmail.com';
    ...
    IF target_user_id IS NOT NULL THEN
        ...
        RAISE NOTICE 'Successfully deleted all data for user: ivan.guelton@gmail.com (ID: %)', target_user_id;
    ELSE
        RAISE NOTICE 'User ivan.guelton@gmail.com not found';
    END IF;
END $$;
