...
CREATE UNIQUE INDEX CONCURRENTLY IF NOT EXISTS user_availability_pattern_unique 
...
CREATE UNIQUE INDEX CONCURRENTLY IF NOT EXISTS user_availability_date_specific_unique 
