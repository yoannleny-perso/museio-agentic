...
-- Delete all data for user estelle.marque@gmail.com
DO $$
DECLARE
    target_user_id UUID;
BEGIN
    ...
    FROM auth.users 
    WHERE email = 'estelle.marque@gmail.com';
    ...
    IF target_user_id IS NOT NULL THEN
        ...
        RAISE NOTICE 'Successfully deleted all data for user: estelle.marque@gmail.com (ID: %)', target_user_id;
    ELSE
        RAISE NOTICE 'User estelle.marque@gmail.com not found';
    END IF;
END $$;
