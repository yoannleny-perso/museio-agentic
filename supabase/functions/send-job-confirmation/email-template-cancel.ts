...
export const createJobCancelationEmail = (data)=>{
...
<body>
  ...
  <section class="email-section">
    <div class="email-header" style="background: linear-gradient(90deg, #FECACA 0%, #FCA5A5 100%);">
      <div class="email-meta" style="text-align: left;">
        <div style="font-size: 22px; font-weight: bold; margin-bottom: 8px;">Job Cancelled</div>
    ...
    <div class="email-body">
      <h3>🛑 The following job has been cancelled</h3>
      <p>Please take note that this job is not going ahead.</p>
      <ul>
      ...
      <p>If this was a mistake or you'd like to reschedule, please reach out to ${artist.name}.</p>
      <p>Best regards,<br>
