...
export const createJobUpdateEmail = (data: JobConfirmationRequest): string => {
...
export function generateEmailHtml(
  job: JobConfirmationRequest["job"], 
  artist: JobConfirmationRequest["artist"], 
): string {
...
<body>
  ...
  <section class="email-section">
    <div class="email-header" style="background: linear-gradient(90deg, #FEF3C7 0%, #FDE68A 100%);">
      <div class="email-meta" style="text-align: left;">
        <div style="font-size: 22px; font-weight: bold; margin-bottom: 8px;">Job Updated</div>
    ...
    <div class="email-body">
      <h3>✏️ The following job has been updated</h3>
      <p>Please review your updated job details below:</p>
      <ul>
      ...
      <p>If anything doesn't look right or you need assistance, please reach out to ${artist.name}.</p>
      <p>Best regards,<br>
